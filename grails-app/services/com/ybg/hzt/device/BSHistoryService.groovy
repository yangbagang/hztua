...
class BSHistoryService {
    ...
    def calculateBySecond(Long batteryId, String key) {
        ...
        def query = "select create_second as xValue, avg(?) as yValue from bshistory where " +
    ...
    def calculateByMinute(Long batteryId, String key) {
        ...
        def startTime = calender.time
        def query = "select create_minute as xValue, avg(?) as yValue from bshistory where " +
    ...
    def calculateByHour(Long batteryId, String key) {
        ...
        def startTime = calender.time
        def query = "select create_hour as xValue, avg(?) as yValue from bshistory where " +
    ...
    def calculateByDay(Long batteryId, String key) {
        ...
        def startTime = calender.time
        def query = "select create_day as xValue, avg(?) as yValue from bshistory where " +
    ...
    def calculateByMonth(Long batteryId, String key) {
        ...
        def startTime = calender.time
        def query = "select create_month as xValue, avg(?) as yValue from bshistory where " +
    ...
    def calculateByYear(Long batteryId, String key) {
        ...
        def startTime = calender.time
        def query = "select create_year as xValue, avg(?) as yValue from bshistory where " +
